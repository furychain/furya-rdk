...
import (
	...
	"github.com/gridironxyz/rollapp/app/evm/flags"
	rollappparams "github.com/gridironxyz/rollapp/app/params"
	"github.com/gridironxyz/rollapp/docs"

	"github.com/gridironxyz/rollapp/x/sequencers"
	seqkeeper "github.com/gridironxyz/rollapp/x/sequencers/keeper"
	seqtypes "github.com/gridironxyz/rollapp/x/sequencers/types"

	distrclient "github.com/cosmos/cosmos-sdk/x/distribution/client"
	distrtypes "github.com/cosmos/cosmos-sdk/x/distribution/types"
	distr "github.com/gridironxyz/rollapp/x/dist"
	distrkeeper "github.com/gridironxyz/rollapp/x/dist/keeper"
	...
	transfer "github.com/gridironxyz/rollapp/x/erc20middleware"
	transferkeeper "github.com/gridironxyz/rollapp/x/erc20middleware/keeper"
)
...
func (app *App) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
	...
	if len(req.Validators) == 0 {
		panic("Furyint have no sequencers defined on InitChain")
	}

	//Passing the furyint sequencers to the sequencer module from RequestInitChain
