...
ifeq (cleveldb,$(findstring cleveldb,$(GRIDIRON_BUILD_OPTIONS)))
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=furya-rdk \
...
ifeq (,$(findstring nostrip,$(GRIDIRON_BUILD_OPTIONS)))
  ldflags += -w -s
endif
ldflags += $(LDFLAGS)
