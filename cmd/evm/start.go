...
import (
	...
	furyintconf "github.com/gridironxyz/furyint/config"
	furyintconv "github.com/gridironxyz/furyint/conv"
	furyintnode "github.com/gridironxyz/furyint/node"
	furyintrpc "github.com/gridironxyz/furyint/rpc"
	"github.com/gridironxyz/rollapp/app"
	"github.com/gridironxyz/rollapp/cmd/common"
	"github.com/gridironxyz/rollapp/utils"
...
// StartCmd runs the service passed in, either stand-alone or in-process with Furyint.
...
`,
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			if !withTM {
				serverCtx.Logger.Error("starting ABCI without Furyint not supported")
				return fmt.Errorf("starting ABCI without Furyint not supported")
			}
